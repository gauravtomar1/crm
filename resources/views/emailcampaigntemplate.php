                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                ...
                                <tr>
                                    <td align="center" height="70" style="height:70px;">
                                        ...
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="100" border="0" style="display: block; width: 100px;" id="blah" src="https://mdbootstrap.com/img/logo/mdb-email.png" alt="" /></a>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                    <tr>
                        ...
                        <td align="center" class="section-img">
                            ...
                            <a href="" style=" border-style: none !important; display: block; border: 0 !important;"><img src="https://mdbootstrap.com/img/Mockups/Lightbox/Original/img (67).jpg" onchange="readImage()" id="coverImage" style="display: block; width: 590px;" width="590" border="0" alt="" /></a>
                    ...
                    <tr>
                        <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                            ...
                            <div style="line-height: 35px">
                                ...
                                <p id="myHeading">NEW IN <span style="color: #5caad2;">NOVEMBER</span></p>
                                 <button type="button" id="buttonheader" class="btn btn-sm btn-primary btn-lg pull-right" onclick="enableHeadingEdit()">Edit Heading</button>
                                 <textarea class="form-control" id="editor2" rows="4" name="htmltext1" style="display:none">Your heading goes here...</textarea>
                                 <button type="button" id="buttonsaveheader" class="btn btn-sm btn-primary btn-lg pull-right" style="display:none;" onclick="saveHeading()">Save Heading</button>   
                            </div>
                        </td>
                    </tr>
                            ...
                            <table border="0" width="400" align="center" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="center" style="color: #888888; font-size: 16px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        ...
                                        <p id="myPara">"Winter is coming. Shop our latest AW16 range, and prepare for the damp, cold, British weather.</p> 
                                        <button type="button" id="buttontext" class="btn btn-sm btn-primary btn-lg pull-right" onclick="enableTextEdit()">Edit Text</button>
                                        <textarea class="form-control" id="editor1" rows="4" name="htmltext" style="display:none">Your message goes here...</textarea>
                                        <button type="button" id="buttonsavetext" class="btn btn-sm btn-primary btn-lg pull-right" style="display:none;" onclick="saveText()">Save Text</button>    
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table border="0" width="300" align="left" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="container590">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        ...
                                        <a href="" style="display: block; border-style: none !important; border: 0 !important;"><img width="80" border="0" style="display: block; width: 80px;" id="footerImage" src="https://mdbootstrap.com/img/logo/mdb-email.png" alt="" /></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="left" style="color: #888888; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 23px;" class="text_color">
                                        <div style="color: #333333; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; font-weight: 600; mso-line-height-rule: exactly; line-height: 23px;">
                                            ...
                                            Email us: <br/> <a href="mailto:" style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">contact@webuyeverywhere.com</a>
                                ...
                                <tr>
                                    <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">WBE CRM</span>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
 <script>
   function enableTextEdit(){
     ...
     function enableHeadingEdit(){
       $("#myHeading").hide();
       $("#buttonheader").hide();
       $("#editor2").show();
       $("#buttonsaveheader").show();
   ...
   function saveText(){
    ...
    function saveHeading(){
       var ckValues = CKEDITOR.instances.editor2.getData();
      // alert(ckValue);
       $("#myHeading").show();
       $("#buttonheader").hide();
       $("#buttonsaveheader").hide();
      $("#myHeading").text(ckValues);
   ...
   function readURL(input) {
    ...
    function readFooterImage(input) {
    if (input.files && input.files[0]) {
        var reader = new FileReader();
        
        reader.onload = function (e) {
            $('#footerImage').attr('src', e.target.result);
        }
